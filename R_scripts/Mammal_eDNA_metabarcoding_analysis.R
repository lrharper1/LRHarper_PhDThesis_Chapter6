...
hm1 <- hm1 + scale_fill_gradient(name="Proportional\nread counts", 
                                 ...
                                 guide=guide_colourbar(frame.colour="black",
                                                       ticks.colour="black"))
hm1 <- hm1 + scale_y_discrete(breaks=c("Arvicola amphibius","Castor fiber",
                                       "Lutra lutra","Erinaceus europaeus",
                                       "Meles meles","Lynx lynx","Cervus elaphus",
                                       "Sciurus vulgaris","Martes martes"),
                              labels=c("Water vole","Beaver","Otter",
                                       "Hedgehog","Badger","Lynx","Red deer",
...
p2 <- p2 + scale_x_discrete(breaks=c("Castor fiber","Lutra lutra","Meles meles","Lynx lynx","Cervus elaphus","Martes martes"),
                            labels=c("Beaver","Otter","Badger","Lynx","Red deer","Pine marten"))
...
p3 <- p3 + scale_colour_manual(guide=guide_legend(nrow=1),
                               ...
                               labels=c("Beaver","Otter","Badger",
                                        "Lynx","Red deer","Pine marten"),
...
m3.df$fSpecies <- factor(m3.df$Species,
                         levels=c("Castor fiber","Lutra lutra","Meles meles",
                                  "Lynx lynx","Cervus elaphus","Martes martes"))
levels(m3.df$fSpecies) <- c("Beaver","Otter","Badger",
                            "Lynx","Red deer","Pine marten")
...
hm2 <- hm2 + scale_y_discrete(breaks=c("Arvicola amphibius","Neomys fodiens",
                                       "Rattus norvegicus","Neovison vison",
                                       "Castor fiber","Lutra lutra",
                                       "Sorex araneus","Myodes glareolus",
                                       "Oryctolagus cuniculus","Lepus europaeus",
                                       ...
                                       "Pipistrellus pipistrellus",
                                       "Sciurus carolinensis","Sciurus vulgaris"),
                              labels=c("Water vole","Water shrew","Brown rat",
                                       "American mink","Beaver","Otter",
                                       "Common shrew","Bank vole","Rabbit",
                                       "Brown hare","Stoat","Weasel","Badger",
                                       "Red fox","Reeve's muntjac","Roe deer",
                                       "Red deer","Wild boar","Dog",
                                       "Pig","Sheep","Cow",
                                       "Common pipistrelle",
...
## Change factor levels to common species names
levels(wild.final$fAssignment) <- c("Common toad","Common frog","Marsh frog",
                                    "Palmate newt","Smooth newt","Great crested newt",
                                    "European eel","Three-spined stickleback",
                                    "Ninespine stickleback","Brown trout",
                                    "Grass carp","Dabbling ducks","Common moorhen",
                                    "White-headed gulls","Grey heron",
                                    "Great tit","Buntings","Song thrush",
                                    "Common starling","Eurasian jay",
                                    "Eurasian magpie","Tawny owl",
                                    "Common buzzard","Rock dove",
                                    "Stock dove","Common pheasant",
                                    "Turkey","Water vole","Water shrew",
                                    "Brown rat","Beaver","Common shrew",
                                    "Bank vole","Rabbit","Roe deer",
                                    "Red deer","Dog","Pig","Sheep","Cow",
                                    "Common pipistrelle","Grey squirrel")
...
## Create factor of common species names
levels(THL.exp$fAssignment) <- c("Common toad","Marsh frog",
                                 "Smooth newt","Great crested newt",
                                 "European eel","Three-spined stickleback",
                                 "Dabbling ducks","Common moorhen",
                                 "White-headed gulls","Grey heron",
                                 "Great tit","Buntings","Song thrush",
                                 "Eurasian magpie","Common pheasant",
                                 "Turkey","Water shrew","Brown rat",
                                 "Common shrew","Rabbit","Roe deer",
                                 "Dog","Pig","Sheep","Cow","Grey squirrel")
